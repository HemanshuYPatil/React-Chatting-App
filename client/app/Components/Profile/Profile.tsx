...
function Profile() {
  ...
  return (
    <div className="px-4 pb-8 w-[90%]  overflow-y-auto scrollbar-hide ">
      <div className="px-4 self-start  text-2xl flex items-center gap-8">
      <span onClick={closechat} className="pl-1 back-profile">{backarrow}</span>
      <h3
        className={`pt-6 pb-8 flex justify-center text-2xl font-black ${gradientText} dark:text-white`}
        style={{marginTop: '5px'}}
        >
          Profile
      </h3>
